        ...
        <Layout>
            <section className="mt-20 px-4 text-white py-4 bg-gradient-to-r from-[#63A7D4] to-[#F295BE]">
                ...
                >
                    ...
                    <span>{t("disclaimer.back")}</span>
                </div>
                <div className="container mx-auto text-center rounded">
                    <h1 className="text-4xl md:text-5xl font-bold text-center text-white mb-4">{t("disclaimer.title")}</h1>
            ...
            <main className="container mx-auto py-8">
                ...
                <section className="bg-white shadow-md rounded-lg p-4">
                    ...
                    <p className="text-lg leading-relaxed mt-4"><strong>{t("disclaimer.sections.contact.legal.title")}</strong></p>
                    <ul className="list-disc ml-6 mt-2">
